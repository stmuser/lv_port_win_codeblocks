...
*/
void lv_example_canvas_v1(void)
{
    ...
    // rect_dsc.bg_grad.stops[2].color = lv_palette_main(LV_PALETTE_GREEN);
    // rect_dsc.bg_grad.stops[2].opa = LV_OPA_20;
...
void test_mycanvs(void)
{

    lv_example_canvas_v1();
}
